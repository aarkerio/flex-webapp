...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__22646_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__22646_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__22647){
...
return ((function (h,e,map__22648,map__22648__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__22650){
var vec__22651 = p__22650;
var ok = cljs.core.nth.call(null,vec__22651,(0),null);
var result = cljs.core.nth.call(null,vec__22651,(1),null);
...
;})(h,e,map__22648,map__22648__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__22654){
...
var format = cljs.core.get.call(null,map__22655__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__22655__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__22655__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__22655__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
...
//# sourceMappingURL=easy.js.map?rel=1541536467493

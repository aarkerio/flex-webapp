...
return (new CustomEvent(event_name,(function (){var obj27842 = {"detail":data};
return obj27842;
})()));
} else {
...
var f = (function (){var pred__27849 = cljs.core._EQ_;
var expr__27850 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27849.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27850))){
return ((function (pred__27849,expr__27850){
return (function (p1__27843_SHARP_){
return console.warn(p1__27843_SHARP_);
});
;})(pred__27849,expr__27850))
} else {
if(cljs.core.truth_(pred__27849.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27850))){
return ((function (pred__27849,expr__27850){
return (function (p1__27844_SHARP_){
return console.debug(p1__27844_SHARP_);
});
;})(pred__27849,expr__27850))
} else {
if(cljs.core.truth_(pred__27849.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27850))){
return ((function (pred__27849,expr__27850){
return (function (p1__27845_SHARP_){
return console.error(p1__27845_SHARP_);
});
;})(pred__27849,expr__27850))
} else {
return ((function (pred__27849,expr__27850){
return (function (p1__27846_SHARP_){
return console.log(p1__27846_SHARP_);
});
;})(pred__27849,expr__27850))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27853){
...
var eval_fn = cljs.core.get.call(null,map__27854__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27856_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27858,(0),null);
var v = cljs.core.nth.call(null,vec__27858,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1541536480518

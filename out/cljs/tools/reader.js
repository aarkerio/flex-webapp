...
var G__22961 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__22961;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__22962 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22962,ch);
...
if(("\\" === ch__$1)){
var ch_22963__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_22963__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_22963__$2);
} else {
}

var G__22964 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__22964;
continue;
}
}
...
var start_line = cljs.core.nth.call(null,vec__22972,(0),null);
var start_column = cljs.core.nth.call(null,vec__22972,(1),null);
...
var G__22975 = cljs.core.conj_BANG_.call(null,a,form);
a = G__22975;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__22976 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__22977 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__22977;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__22976;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__22978 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22978,(0),null);
var start_column = cljs.core.nth.call(null,vec__22978,(1),null);
...
var vec__22981 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22981,(0),null);
var end_column = cljs.core.nth.call(null,vec__22981,(1),null);
...
var vec__22984 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22984,(0),null);
var start_column = cljs.core.nth.call(null,vec__22984,(1),null);
...
var vec__22987 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22987,(0),null);
var end_column = cljs.core.nth.call(null,vec__22987,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__22990,(0),null);
var start_column = cljs.core.nth.call(null,vec__22990,(1),null);
...
var vec__22993 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22993,(0),null);
var end_column = cljs.core.nth.call(null,vec__22993,(1),null);
...
var sb = (function (){var G__22996 = (new goog.string.StringBuffer());
G__22996.append(initch);
...
var G__22998 = (function (){var G__22997 = sb;
G__22997.append(ch);

return G__22997;
})();
var G__22999 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__22998;
ch = G__22999;
continue;
}
...
switch (G__23002) {
case "\\":
var G__23006 = (function (){var G__23003 = sb;
G__23003.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__23003;
})();
var G__23007 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__23006;
ch = G__23007;
continue;
...
break;
default:
var G__23008 = (function (){var G__23004 = sb;
G__23004.append(ch);

return G__23004;
})();
var G__23009 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__23008;
ch = G__23009;
continue;
...
var vec__23010 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23010,(0),null);
var end_column = cljs.core.nth.call(null,vec__23010,(1),null);
...
var vec__23013 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__23013,(0),null);
var column = cljs.core.nth.call(null,vec__23013,(1),null);
...
var line = cljs.core.nth.call(null,vec__23018,(0),null);
var column = cljs.core.nth.call(null,vec__23018,(1),null);
...
var line = cljs.core.nth.call(null,vec__23023,(0),null);
var column = cljs.core.nth.call(null,vec__23023,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var G__23034 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__23034,true,null,opts,pending_forms);
...
var G__23035 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__23035)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__23035)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__23035)){
...
var _STAR_suppress_read_STAR__orig_val__23036 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__23037 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__23037;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__23036;
}});
...
var G__23038 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__23038,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__23038,rdr,first_line);
...
var G__23042 = matched;
var G__23043 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__23042;
finished = G__23043;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__23044 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__23045 = (function (){var or__4047__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__23045;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__23044;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__23046 = cljs.tools.reader.arg_env;
var arg_env_temp_val__23047 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__23047;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__23048 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__23048,"(");
...
var G__23049 = (i + (1));
var G__23050 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4047__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__23046;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__23051 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__23051);
...
var G__23052 = cljs.core.next.call(null,s__$1);
var G__23053 = ret;
s__$1 = G__23052;
r = G__23053;
continue;
...
var G__23054 = cljs.core.next.call(null,s);
var G__23055 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__23054;
key_vals = G__23055;
continue;
} else {
...
var gensym_env_orig_val__23059 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__23060 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__23060;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__23059;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__23061 = token;
var G__23061__$1 = (((G__23061 == null))?null:cljs.core.subs.call(null,G__23061,(1)));
var G__23061__$2 = (((G__23061__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__23061__$1));
var G__23061__$3 = (((G__23061__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__23061__$2));
var G__23061__$4 = (((G__23061__$3 == null))?null:cljs.core.symbol.call(null,G__23061__$3));
if((G__23061__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__23061__$4);
}
})():(function (){var G__23062 = token;
var G__23062__$1 = (((G__23062 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__23062));
if((G__23062__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__23062__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e23069){if((e23069 instanceof Error)){
var e = e23069;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__23073,reader){
...
var eof = cljs.core.get.call(null,map__23074__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4641__auto___23082 = arguments.length;
var i__4642__auto___23083 = (0);
while(true){
if((i__4642__auto___23083 < len__4641__auto___23082)){
args__4647__auto__.push((arguments[i__4642__auto___23083]));

var G__23084 = (i__4642__auto___23083 + (1));
i__4642__auto___23083 = G__23084;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq23080){
var G__23081 = cljs.core.first.call(null,seq23080);
var seq23080__$1 = cljs.core.next.call(null,seq23080);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23081,seq23080__$1);
});


//# sourceMappingURL=reader.js.map?rel=1541536470604
